...
import sarithaImage from "../assets/Sarithaportfolio.jpg";
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12">
          ...
          <div className="flex-1 text-center lg:text-left" data-aos="fade-right">
            ...
            <h1 className="text-5xl lg:text-6xl font-bold text-primary mb-4 animate-fade-in-up animate-delay-300">
              Hi, I'm <span className="bg-gradient-to-r from-blue-600 via-purple-600 to-cyan-500 bg-clip-text text-transparent">Saritha</span>
            </h1>
            ...
            <div className="flex justify-center lg:justify-start gap-6">
              <a
                href="https://www.linkedin.com/in/bonthu-saritha-2b5601376/"
                target="_blank"
              ...
              <a
                href="https://github.com/SarithaDev123"
                target="_blank"
                rel="noopener noreferrer"
